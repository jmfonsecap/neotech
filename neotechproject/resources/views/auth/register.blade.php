                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form method="POST" class="space-y-4 md:space-y-6 items-center" action="{{ route('register') }}">
                        ...
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            {{ __('messages.auth.alreadyaccount') }} <a href="{{ route('login') }}" class="font-medium text-primary-600 hover:underline dark:text-primary-500">{{ __('messages.auth.loginhere') }}</a>
                        </p>
                    </form>
                </div>
            </div>

        ...
        <form method="POST" action="{{ route('admin.type.save') }}" enctype="multipart/form-data">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                ...
                <div class="py-3 flex items-center mb-4">
                    <input name="is_base" id="is_base" type="checkbox" value="1" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">

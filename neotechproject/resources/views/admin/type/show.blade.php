...
<section class="bg-white dark:bg-gray-900">
  <div class="pt-3">
    <h2 class="mb-4 text-2xl text-center tracking-tight font-bold text-gray-900 dark:text-gray-400"> {{ __('messages.admin.types.info') }} </h2>
  ...
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
    ...
    <h2 class="mb-2 text-xl font-semibold leading-none text-gray-900 md:text-2xl dark:text-white"> {{ $viewData['type']->getName() }} </h2>

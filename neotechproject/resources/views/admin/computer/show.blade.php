...
<section class="bg-white dark:bg-gray-900">
  <div class="pt-3">
    <h2 class="mb-4 text-2xl text-center tracking-tight font-bold text-gray-900 dark:text-gray-400"> {{ __('messages.admin.computers.info') }} </h2>
  ...
  <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
    ...
    <dl class="flex items-center space-x-6">
      ...
      <div>
        <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white"> {{ __('messages.admin.computers.currentprice') }} </dt>
        <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400"> {{ $viewData['computer']->getCurrentPrice() }} </dd>
      </div>
    </dl>

...
<main class="flex flex-col h-screen">
  ...
  <div class="overflow-y-auto py-5 px-3 h-full bg-white border-r border-gray-200 dark:bg-gray-700 dark:border-gray-700">
      ...
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2021-2022 </span>
      </div>
      <div class="text-center">
        <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"><a href="#" class="hover:underline">Flowbite™</a>.</span>
      </div>
      <div class="text-center">

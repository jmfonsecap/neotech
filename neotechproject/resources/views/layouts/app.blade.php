        ...
        <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
            <div class="flex flex-wrap justify-between items-left mx-auto max-w-screen-xl">
                ...
                <div class="flex items-center lg:order-2">
                    ...
                    <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="w-10 h-10 rounded-full cursor-pointer" src="{{ asset('/img/undraw_profile.svg') }}" alt="User dropdown">
                    ...
                    <div id="userDropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
                            <li>
                                <a href="{{ route('user.custom.index') }}" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">{{ __('messages.user.custom.computer') }}</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <li>
                            <form role="search" action="{{route('search')}}" method="POST" class="hidden md:block md:pl-2">
                                ...
                                <div class="input group relative md:w-64 md:w-96">
                                    ...
                                    @csrf
                                    <input type="text" name="query" id="topbar-search" class="form control bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Search" />
                                </div>
                            </form>
    ...
    <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl text-center">
            <div style="display: flex; justify-content: center;">
                <img src="https://github.com/jmfonsecap/neotech/blob/main/NEOTECH%20LOGO%20PC.png?raw=true" class="mr-3 h-6 sm:h-9" alt="Neotech Logo" />
            </div>
            <p class="my-6 text-gray-500 dark:text-gray-400">{{ __('messages.purpose') }}</p>
            <ul class="flex flex-wrap justify-center items-center mb-6 text-gray-900 dark:text-white">
                <li>
                    <a href="{{route('language.locale', ['locale' => 'en'])}}" class="mr-4 hover:underline md:mr-6 ">{{ __('messages.user.language.en') }}</a>
                </li>
                <li>
                    <a href="{{route('language.locale', ['locale' => 'es'])}}" class="mr-4 hover:underline md:mr-6">{{ __('messages.user.language.es') }}</a>
                </li>
                <li>
                    <a href="{{route('language.locale', ['locale' => 'fr'])}}" class="mr-4 hover:underline md:mr-6 ">{{ __('messages.user.language.fr') }}</a>
                </li>
            </ul>
